            ...
            Row(children: <Widget>[
              ...
              Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(border: OutlineInputBorder(), hintText: '이메일을 입력하세요.', hintStyle: TextStyle(fontSize: 14)),
                  ))
            ]),
            Row(children: <Widget>[
              Container(
                  margin: EdgeInsets.only(right: 15.w), width: 100.w, height: 20.h, child: FittedBox(fit: BoxFit.fitHeight, child: Text("비밀번호"))),
              Container(
                  margin: EdgeInsets.only(right: 10.w, bottom: 8.h),
                  width: 230.w,
                  height: 30.h,
                  child: TextField(
                    ...
                    textAlign: TextAlign.left,
                    obscureText: true,
                    decoration: InputDecoration(border: OutlineInputBorder(), hintText: '비밀번호를 입력하세요.', hintStyle: TextStyle(fontSize: 14)),
                  ))
            ]),
            Container(
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            var response = await http.Client().post(Uri.parse("http://${devMode()}.dalbodre.me/api/User/Register"),

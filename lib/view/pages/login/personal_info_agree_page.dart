...
class PersonalInfoAgree extends State<PersonalInfoAgreePage> {
  ...
  List<String> agreedContents = [
    '''
    아름드림은 회원가입을 하셔야 해당 서비스를 이용하실 수 있습니다.
    ''',
    '''개인정보보호법에 따라 아름드림에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보
 이용자가 베타 테스트 기간동안 아름드림을 이용하기 위해 회원가입을 할 경우, "달보드레"는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 달보드레가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
- 회원 가입 시 ‘아이디, 비밀번호, 이름, 휴대전화번호’를 필수항목으로 수집합니다.

              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Scrollbar(
                        isAlwaysShown: true,
                        controller: this._scrollController3,
                        child: new SingleChildScrollView(
                            controller: this._scrollController3,
                            scrollDirection: Axis.vertical,
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [Text(agreedContents[2])],
                            )),
                      )),
                  Container(
                    height: 25.h,
                    ...
                    child: Row(
                      children: [
                        Transform.scale(
                            scale: 1.4,
                            child: Checkbox(
                              value: this.thirdAgreed,
                              onChanged: (bool? value) {
                                setState(() {
                                  this.thirdAgreed = value!;
                                });
                              },
                            )),
                        Container(
                  ...
                  Container(
                      ...
                      child: Scrollbar(
                        isAlwaysShown: true,
                        controller: this._scrollController4,
                        child: new SingleChildScrollView(
                            controller: this._scrollController4,
                            scrollDirection: Axis.vertical,
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [Text(agreedContents[3])],
                            )),
                      )),
                  Container(
                    height: 25.h,
                    ...
                    child: Row(
                      children: [
                        Transform.scale(
                            scale: 1.4,
                            child: Checkbox(
                              value: this.fourthAgreed,
                              onChanged: (bool? value) {
                                setState(() {
                                  this.fourthAgreed = value!;
                                });
                              },
                            )),
                        Container(
                          ...
                          child: FittedBox(
                            fit: BoxFit.fitHeight,
                            child: Text("정보주체와 법정대리인의 권리•의무  동의 (필수)",
                                style: TextStyle(
                                    fontFamily: "NotoSans", fontSize: 16)),
                          ),
                        ),
                  ...
                  Container(
                      ...
                      child: Scrollbar(
                        isAlwaysShown: true,
                        controller: this._scrollController5,
                        child: new SingleChildScrollView(
                            controller: this._scrollController5,
                            scrollDirection: Axis.vertical,
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [Text(agreedContents[4])],
                            )),
                      )),
                  Container(
                    height: 25.h,
                    ...
                    child: Row(
                      children: [
                        Transform.scale(
                            scale: 1.4,
                            child: Checkbox(
                              value: this.fifthAgreed,
                              onChanged: (bool? value) {
                                setState(() {
                                  this.fifthAgreed = value!;
                                });
                              },
                            )),
                        Container(

...
class UserFavoriteStoresDatabase {
  ...
  static final thumbnailPath = 'thumbnail_path';
  static final latitude = 'latitude';
  static final longitutde = 'longitude';

  // make this a singleton class
  UserFavoriteStoresDatabase._privateConstructor();
  static final UserFavoriteStoresDatabase instance =
      UserFavoriteStoresDatabase._privateConstructor();

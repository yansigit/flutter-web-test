      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            CupertinoTextField(
              placeholder: "내용을 입력해주세요. (예시)물 더 넣어주세요.",
        ...
        onTap: () {
          switch (id) {
            case 1:
              function(1);
              cartOptions["iceSize"] =
                  new CartOption(name: "적게", price: 0, quantity: 1);
              break;
            case 2:
              function(2);
              cartOptions["iceSize"] =
            ...
            case 3:
              function(3);
              cartOptions["iceSize"] =
                  new CartOption(name: "많이", price: 0, quantity: 1);
              break;
          }
        });
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                      child: iceSizeStyle(
                          _c.updateIceQuantity,
                          _c.selectIceQuantity.value,
                          _c.selectHotColdOption.value)),
                ),
              ],
            ),
          );
...
class ExpandableContainer extends StatelessWidget {
  ...
  double get containerHeight {
    if (_c.selectHotColdOption.value != 2) {
      expandedHeight = expandedHeight - 207.6.h;
    } else {
...
class SelectSizeWidget extends StatelessWidget {
  ...
  Widget smallSize(int selected) {
    return InkWell(
      ...
      onTap: () {
        cartOptions["size"] =
            new CartOption(name: "작은 사이즈", price: 0, quantity: 1);
        function(1);
      },
    );
  }
  ...
  Widget midSize(int selected) {
    return InkWell(
      ...
      onTap: () {
        cartOptions["size"] =
            new CartOption(name: "중간 사이즈", price: 0, quantity: 1);
        function(2);
      },
    );
  }
  ...
  Widget bigSize(int selected) {
    return InkWell(
      ...
      onTap: () {
        cartOptions["size"] =
            new CartOption(name: "큰 사이즈", price: 0, quantity: 1);
        function(3);
      },
    );
  }
      ...
      child: Row(
        ...
        children: [
          ...
          Align(
            ...
            child: Container(color: Colors.red, child: Text("TESYASDFA")),
          ),
        ],
      ),
    );
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        ...
                        if (text.isNotEmpty) {
                          cartOptions["etcOption"] =
                              new CartOption(name: text, price: 0, quantity: 1);
                        } else {
                          cartOptions["etcOption"] =
